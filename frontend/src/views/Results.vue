<template>
  <div class="home">
    ...
    <div class="question"><span>You earned&nbsp</span>      <img class="star-img" src="../../src/assets/star.png">
<span>{{ stars }} stars!</span></div>
    ...
    <div v-on:click="finished" class="answers">
...
<style scoped>
  ...
  .enemy-img {
    ...
    height: 260px;
    background-repeat: no-repeat;
    background-image:  url("../../src/assets/q1_enemy.svg");
  }
  ...
  .hurt-enemy-img {
    ...
    height: 260px;
    background-repeat: no-repeat;
    background-image:  url("../../src/assets/q1_enemy_hurt.svg");
...
@keyframes enemy-hurt {
  12.5% {
    background-image: url(../../src/assets/q1_enemy_hurt.svg), url(../../src/assets/q1_enemy_hurt_red.svg);
    background-blend-mode: multiply;
    transform: translate(15px, 15px);
  }
  25% {
