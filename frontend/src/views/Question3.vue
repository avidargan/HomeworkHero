<template>
  <div class="home">
    ...
    <div v-if="!finished" class="question">What's 3 x 4?</div>
    </transition>
    ...
    <div v-if="!finished" class="answers">
      <transition name="slide-fade">
      <button v-if="showA" v-on:click="wrongAnswerA" class="pixel-button">
        A) 10
      </button>
      </transition>
      ...
      <button v-if="showD" v-on:click="rightAnswerD" class="pixel-button">
        D) 12
      </button>
    </div>
    </transition>
