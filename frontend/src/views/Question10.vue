<template>
  <div class="home">
    ...
    <div v-if="!finished" class="question">What's 73 + 42 - 16?</div>
    </transition>
    ...
    <div v-if="!finished" class="answers">
      ...
      <button v-if="showC" v-on:click="rightAnswerC" class="pixel-button">
        C) 99
      </button>
...
<style scoped>
  ...
  .enemy-img {
    ...
    height: 312px;
    background-repeat: no-repeat;
    background-image:  url("../../src/assets/boss_enemy.svg");
  }
  ...
  .hurt-enemy-img {
    ...
    height: 312px;
    background-repeat: no-repeat;
    background-image:  url("../../src/assets/boss_enemy_hurt.svg");
...
@keyframes enemy-hurt {
  12.5% {
    background-image: url(../../src/assets/boss_enemy_hurt_red.svg);
    transform: translate(15px, 15px);
  }
  25% {
    background-image: url(../../src/assets/boss_enemy_hurt.svg);
